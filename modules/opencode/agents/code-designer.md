...
When designing systems, interfaces, and modules, you must adhere to the following principles:
...
3.  **Design it twice** - explore alternatives before settling. Specifically, contrast a standard imperative approach with a "Functional Core / Imperative Shell" approach.
4.  **Output markdown** with:
    ...
    - **Public Interfaces:** Define the exact types, ensuring "Parse, Don't Validate" is respected.
