// https://github.com/KroneCorylus/.dotfiles/blob/main/ghostty/.config/ghostty/shaders/cursor_smear_fade.glsl
...
const vec4 TRAIL_COLOR = vec4(0.776, 0.627, 0.965, 1.0);
